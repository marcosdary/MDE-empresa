        ...
        <div class="card-body">
            <div class="col-md-12"> <!-- Alterado para col-md-12 para usar toda a largura disponível -->
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h4>Locais dos Departamentos</h4>
                    <a class="btn btn-primary" href="novo-local-departamento.php">Novo Local do Departamento</a>
                </div>
                <div class="card-body">
                    <table class="table table-striped full-width-table">
                        ...
                        <tbody>
                            <?php
                            $sql = "
                            select idLocalDepartamento as id_local_departamento, Nome as nome from local_departamento
                            order by nome;
                            ";
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <form action="editar-local-departamento.php" method="POST" style="display:inline;">
                                            <input type="hidden" name="id_local_departamento" value="<?= htmlspecialchars($row->id_local_departamento) ?>">
                                        ...
                                        <form action="atividades-mysql.php" method="POST" class="d-inline">
                                            <button onclick="return confirm('Tem certeza que deseja excluir?')" 
                                                type="submit" name="delete_local_departamento" 
                                                value="<?= htmlspecialchars($row->id_local_departamento)?>" class="btn btn-danger btn-sm">
